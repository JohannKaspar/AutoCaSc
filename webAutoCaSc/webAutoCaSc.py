    ...
    if active_tab == "overview_tab":
        ...
        if status_code == 200:
            ...
            tab_card_content = [
                ...
                dbc.Tooltip(f"About {get_percentile(_instance_attributes.get('candidate_score'))} of the scored variants @Institute for Human Genetics Leipzig had a lower score than this.",
