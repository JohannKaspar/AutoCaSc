    ...
    for case in variant_df.Case_Number.unique():
        ...
        for trio, trio_path in [("CEU", "/mnt/raid/users/johann/VCFs/CeuTrio.hc-joint.MergeVcf.recalibrated.split.vcf.gz"),
            ...
            command = f"python add_variant_to_vcf.py " \
                      ...
                      f"-i {trio_path} " \
                      f"-o /mnt/raid/users/johann/VCFs/modified_VCFs/{trio}_{case}.vcf.gz " \
    ...
    for case in variant_df.Case_Number.unique():
        ...
        for trio in ["ASH", "CEU"]:
            ...
            subprocess.run(shlex.split("python /home/johann/PycharmProjects/AutoCaSc_project_folder/AutoCaSc_core/vcfAutoCaSc.py "
                                       ...
                                       # f"-vcf_non_ch '/home/johann/trio_scoring_results/synthetic_trios/{date}/cache/{trio}_{case}/{trio}_a{ped_suffix}_non_comphets' "
                                       # f"-vcf_ch '/home/johann/trio_scoring_results/synthetic_trios/{date}/cache/{trio}_{case}/{trio}_a{ped_suffix}_comphets' "
