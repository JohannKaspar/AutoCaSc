...
def load_sample_excel():
    sample_ids = pd.read_excel("/home/johann/PycharmProjects/AutoCaSc_project_folder/paper/data/family_sample_ids.xlsx",
...
def load_cnv_excel(sample_excel):
    cnv_docu_chunk = pd.read_excel("/home/johann/PycharmProjects/AutoCaSc_project_folder"
                                   "/paper/data/family_number_sex_2021_01_25.xlsx",
                                   skiprows=2,
                                   header=None)
    ...
    cnv_docu_chunk.to_csv("/home/johann/PycharmProjects/AutoCaSc_project_folder"
                          "/paper/data/family_number_sex_subset.csv",
                          index=False)
...
def create_ped_files():
    for i, row in sample_ids.iterrows():
        ...
        if sex == "m":
            ...
            sex_code = 2
        try:
            with open("/home/johann/PycharmProjects/AutoCaSc_project_folder/paper/data/ped_files/" + f"{family_id}.ped", "w") as _ped_file:
