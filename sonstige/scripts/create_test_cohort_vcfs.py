...
def lookup_parameters_old():
    for entry in os.scandir("/home/johann/trio_scoring_results/varvis_trios/mim_mapped/"):
        if entry.is_file() and not "concat" in entry.name:
